...
class CaptionGenerator(object):
    def __init__(self, rnn_model_place, cnn_model_place, dictonary_place,
                 beamsize=3, depth_limit=50, gpu_id=-1, first_word="<sos>",
                 hidden_dim=512, mean="imagenet"):
        self.gpu_id = gpu_id
    ...
    def successor(self, current_state):
        ...
        Returns:
            k_best_next_states: a python list whose length is the beam size.
            possible_sentences[i] = {"indicies": list of word indices,"cost":negative log likelihood so far}
