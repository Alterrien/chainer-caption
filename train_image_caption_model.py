...
from code.CaptionDataLoader2 import CaptionDataLoader
from code.CaptionMultiDataLoader import CaptionMultiDataLoader
from code.CaptionEvaluater import CaptionEvaluater
...
parser.add_argument(
    '--captions', default='./data/MSCOCO/mscoco_train2014_all_preprocessed.json',
    type=str,
    help='''
    path to preprocessed caption json or, multi like
    <en>:./data/MSCOCO/mscoco_train2014_all_preprocessed.json;<jp>:./data/MSCOCO/mscoco_jp_all_preprocessed.json;
    '''
)
